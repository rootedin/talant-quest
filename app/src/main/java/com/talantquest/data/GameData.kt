...
object GameData {
    ...
    val quizTags = listOf(
        ...
        QuizTag("11", listOf(
            QuizQuestion("예수님은 베드로가 닭 울기 전에 자신을 몇 번 부인할 것이라 하셨나요?",
                listOf("한 번", "두 번", "세 번", "일곱 번"), 2),
            QuizQuestion("선한 사마리아인 비유에서 강도 만난 사람을 도운 사람은?",
                listOf("제사장", "레위인", "사마리아인", "바리새인"), 2),
            QuizQuestion("예수님의 열두 제자 중 세리 출신이었던 사람은?",
                listOf("베드로", "마태", "도마", "안드레"), 1),
            QuizQuestion("예수님이 죽은 지 나흘 된 나사로를 살리신 마을은?",
                listOf("가버나움", "베다니", "나사렛", "벳새다"), 1)
        )),
        QuizTag("12", listOf(
            QuizQuestion("믿음의 조상 아브라함의 아내 이름은?",
                listOf("하갈", "리브가", "사라", "라헬"), 2),
            QuizQuestion("야곱이 사랑하여 요셉을 낳은 아내는?",
                listOf("레아", "라헬", "빌하", "실바"), 1),
            QuizQuestion("이스라엘 백성이 광야에서 먹은, 하늘에서 내린 양식은?",
                listOf("메추라기", "만나", "무화과", "보리떡"), 1),
            QuizQuestion("모세가 십계명 두 돌판을 받은 산은?",
                listOf("시온 산", "시내 산", "갈멜 산", "감람 산"), 1)
        )),
        QuizTag("13", listOf(
            QuizQuestion("찬송가 '주 예수보다 더 귀한 것은' 다음에 이어지는 가사는?",
                listOf("있네", "없네", "많네", "크네"), 1),
            QuizQuestion("'나 같은 죄인 살리신' 다음에 이어지는 가사는?",
                listOf("주 사랑 놀라워", "주 은혜 놀라워", "주 능력 놀라워", "주 영광 놀라워"), 1),
            QuizQuestion("다윗이 지은 노래가 많이 담긴 성경의 책은?",
                listOf("잠언", "전도서", "시편", "아가"), 2),
            QuizQuestion("예수님이 제자들에게 직접 가르쳐 주신 기도는?",
                listOf("사도신경", "주기도문", "십계명", "산상수훈"), 1)
        )),
        QuizTag("14", listOf(
            QuizQuestion("예수님의 제자는 모두 몇 명이었나요?",
                listOf("7명", "10명", "12명", "40명"), 2),
            QuizQuestion("노아 홍수 때 비가 며칠 동안 내렸나요?",
                listOf("7일", "12일", "40일", "70일"), 2),
            QuizQuestion("성경은 모두 몇 권의 책으로 이루어져 있나요?",
                listOf("39권", "27권", "66권", "72권"), 2),
            QuizQuestion("예수님이 십자가에 못 박히신 곳의 이름은?",
                listOf("겟세마네", "골고다", "감람 산", "베들레헴"), 1)
        )),
        QuizTag("15", listOf(
            QuizQuestion("구약성경의 첫 번째 책과 마지막 책은?",
                listOf("창세기 - 요한계시록", "창세기 - 말라기", "출애굽기 - 말라기", "창세기 - 욥기"), 1),
            QuizQuestion("신약성경의 첫 번째 책은?",
                listOf("마가복음", "마태복음", "사도행전", "로마서"), 1),
            QuizQuestion("'믿음, 소망, 사랑 중에 그중에 제일은' 무엇인가요? (고전 13장)",
                listOf("믿음", "소망", "사랑", "은혜"), 2),
            QuizQuestion("사울(바울)이 예수님을 만나 회심한, 가던 길의 지명은?",
                listOf("예루살렘", "다메섹", "안디옥", "로마"), 1)
        ))
    )
    ...
    val codeTags = listOf(
        ...
        CodeTag("07", "운동장 국기 게양대 아래를 확인해봐!", "LIGHT7", 120),
        CodeTag("08", "본당 강대상 뒤편 의자 밑을 살펴봐!", "TRUTH8", 140),
        CodeTag("09", "매점 음료 냉장고 옆 벽을 확인해봐!", "BREAD9", 110),
        CodeTag("10", "2층 계단 난간 손잡이 끝을 만져봐!", "ROCK10", 130),
    )
