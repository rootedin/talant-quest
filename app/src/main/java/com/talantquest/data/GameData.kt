...
object GameData {
    ...
    val investOptions = listOf(
        ...
        InvestOption("고액 투자", "🎰", 500, "500달란트 → 성공 시 2배(1000달란트) 반환"),
    )
    ...
    val quizTags = listOf(
        QuizTag("01", listOf(
            QuizQuestion("새우물침례교회 담임목사님의 성함은?",
                listOf("김장진", "김상신", "김장신", "김상진"), 3),
            QuizQuestion("새우물침례교회가 위치한 도시는?",
                listOf("수원시", "화성시", "오산시", "평택시"), 2),
            QuizQuestion("새우물침례교회의 표어는 무엇인가요?",
